...
const sampler_t s_repeat  = CLK_FILTER_NEAREST | CLK_NORMALIZED_COORDS_FALSE | CLF_ADDRESS_REPEAT;

__kernel void image_test(__read_only image2d_t im, __gloabl float* out) {
